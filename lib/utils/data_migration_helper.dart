      ...
      for (final doc in snapshot.docs) {
        ...
        if (userName != null && userId != null) {
          ...
          if (userName.contains('@')) {
            print('Found inquiry with email as userName: $userName for userId: $userId');
            
            // 실제 사용자 이름 조회
            final actualUserName = await _userProfileService.getUserName(userId);
      ...
      for (final userDoc in usersSnapshot.docs) {
        ...
        if (name != null) {
          ...
          if (!profileDoc.exists) {
            print('Creating missing profile for user: $userId with name: $name');
